...
export const meta: MetaFunction = () => {
  return [
    { title: "Sign Up | Prompt Overflow" },
    { name: "description", content: "Create a new account on Prompt Overflow" },
  ];
};
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    const user = await register(result.email, result.username, result.password);
    if (!user) {
